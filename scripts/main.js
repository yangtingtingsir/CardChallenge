    ...
    window.RateLimiter = class RateLimiter {
        ...
        Call()
        {
            ...
            if (timeSinceLastCall >= interval && this._canRunImmediate) {
                ...
                this._timerId = self.setTimeout(this._timerCallFunc,
    ...
    window.RuntimeInterface = class RuntimeInterface {
        ...
        _OnEventFromRuntime(e)
        {
            ...
            try {
                ...
                if (responseId !== null)
                    this._PostResultToRuntime(responseId, false,
                    "" + err);
                return
            }
            if (responseId === null)
        ...
        async _AddEffect(e)
        {
            ...
            for (const tag of tags) {
                ...
                "filter")
                    ...
                    effect = new self.C3AudioGainFX(this,
                    ...params);
    ...
    self.C3AudioBuffer = class C3AudioBuffer {
        ...
        CreateInstance(tags)
        {
            if (this._api === "html5")
                ...
                return new self.C3WebAudioInstance(this._audioDomHandler,
                this, tags)
        }
        _Load() {}
        Load()
        ...
        _OnNavigate(e)
        {
            ...
            if (type === "back")
                ...
                if (self["cordova"] && self["cordova"]["InAppBrowser"])
                    self["cordova"]["InAppBrowser"]["open"](url,
                    "_system");
...
'use strict';
{
    ...
    class C3Consent {
        ...
        async GetTrackingAuthorizationStatus()
        {
            ...
            const idfaInfo = await idfaPlugin["getInfo"]();
            if (!idfaInfo["trackingLimited"])
                return this._trackingStatusString =
                "authorized";
...
'use strict';
{
    ...
    addHandler("CreateBannerAdvert", async (id, size, debug, position, reload, fn) => {
        ...
        if (!bannerAd)
            bannerAd = new C3BannerAd(id, size, position, fn);
...
'use strict';
{
    ...
    addHandler("RequestConsent", async (...a) => {
        const [data,
        fn] = getArgument("RequestConsent", a);
        await sleep(50);
        fn(null, STATUS_PERSONALISED + "&&true")
    });
